...
public class GalleryController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            List<GalleryModel> listGallery = galleryDAO.getAll();
            
            int id = Integer.parseInt(request.getParameter("id"));
            GalleryModel galleryModel = galleryDAO.findById(id);
            galleryDAO.updatePageCounter();
            int pageCounter = galleryDAO.getPageCounter();
            
            
            request.setAttribute("pageCounter", pageCounter);
            request.setAttribute("listGallery", listGallery);
            request.setAttribute("galleryModel", galleryModel);
